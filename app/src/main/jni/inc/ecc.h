...
#                define EscEcc_USE_DUAL_MULTIPLY_ADD
#            endif
#        endif
#    endif
#endif
...
#define EscEcc_MAX_LONG_WORDS ( 2U * EscEcc_MAX_WORDS )
...
typedef struct {
    /** the words of the long number */
    UINT32 word[ EscEcc_MAX_LONG_WORDS ];
...
/* The following functions are only used internally by other modules */
/* ----------------------------------------------------------------- */
