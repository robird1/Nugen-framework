 ...
 * ===========================================================================
 *
 * Class name: GetBrpTemplateStatus
 * Brief: BLE Command: get BRP template status
 *
 * Create Date: 11/03/2015
 * $Revision: 24156 $
 * $Author: JacksonHuang $
 * $Id: GetBrpTemplateStatus.java 24156 2015-11-16 05:50:26Z JacksonHuang $
 */
...
public class GetBrpTemplateStatus implements IBLERequest
{
    ...
    // Instance
    private static volatile GetBrpTemplateStatus mInstance = null;
    ...
    // Indication Response
    private GetBrpTemplateStatusResponse mGetBrpTemplateStatusResponse = 
                                            new GetBrpTemplateStatusResponse();
    ...
    private GetBrpTemplateStatus(Context context)
    {
        mContext = context;       
    }    
     ...
     * 
     */
    public static GetBrpTemplateStatus getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new GetBrpTemplateStatus(context);
        }
        else
        {
    ...
    {
        // Data to BLE
        byte[] data = { (byte)0xEE, (byte)0x11, BRP_TEMPLATE_CODE};
    ...
    /**
     * Indication of GetBrpTemplateStatus
     * 
     */    
    
    class GetBrpTemplateStatusResponse implements ResponseProcess
    {
        ...
        public void doProcess(Context context, Intent intent)
        {
            Debug.printD(TAG, "Response enter ==> Get Basal Template");
            ...
            switch(iOpCode)
            {
            case ControlPointConstant.OpCode.IDSCMD_GET_TMPL_STATUS_RESP:
                ...
                if (iE2EResult == E2E_Result.RESULT_OK)
                {
                    ...
                    Debug.printD(TAG, " [GetBrpTemplateStatus]: E2E_Result.RESULT_OK");
                }
                else
                {
                    isResult = SafetyBoolean.FALSE;
                    Debug.printD(TAG, " [GetBrpTemplateStatus]: E2E_Result.RESULT_NNNNNNNNNNNNNNNNNNNNNOK");
                }
            ...
            case ControlPointConstant.OpCode.IDSCMD_RESP:
                ...
                if (iCommandCode == 
                        ControlPointConstant.OpCode.IDSCMD_GET_TMPL_STATUS)
                {
                    Debug.printD(TAG, " [GetBrpTemplateStatus]: STD CMD Error");
                    setupReturnResult(SafetyBoolean.FALSE, null);
                }
