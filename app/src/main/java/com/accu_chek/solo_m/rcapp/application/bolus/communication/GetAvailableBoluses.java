 ...
 * ===========================================================================
 *
 * Class name: GetAvailableBoluses
 * Brief: FIXME
 *
 * Create Date: 11/05/2015
 * $Revision: 23382 $
 * $Author: LuyaHuang $
 * $Id: GetAvailableBoluses.java 23382 2015-11-05 08:22:35Z LuyaHuang $
 */
...
public class GetAvailableBoluses extends BolusCommunicationManager
{
    private final String mDebugTag = "GetAvailableBoluses";
    
    private GetAvailableBoluses()
    {}
    
    private static volatile GetAvailableBoluses instance = null;
    
    public static GetAvailableBoluses getInstance()
    {
        if(null == instance)
        {
            instance = new GetAvailableBoluses();
        }
    ...
    public void onRequestCompleted(SafetyBoolean result)
    {
        ...
        {
            Debug.printD(mDebugTag, "GetAvailableBoluses OK");
        }
        else
        {
            Debug.printD(mDebugTag, "GetAvailableBoluses NG");
        }
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        {            
            ...
            if((GET_AVAILABLE_BOLUSES_RES_OP == opCode) && (CommsConstant.E2E_Result.RESULT_OK == result))
            {
                byte flag = buff.get();
                ...
                Debug.printD(mDebugTag, "flag = " + String.format("0x%x", flag));
    ...
    public void getAvailableBolusesType(Context context)
    {
        CommonUtils.objectCheck(context);
        
        getAvailableBoluses(context);
