...
/**
 * Request for command CommsConstant.CommandCode.BT_DISCONNECT.
 * 
 * @author EDLiu
 * @version 1.0
 * @created 24-Feb-2015 6:52:08 PM
 */
public class DisconnectRequest implements IRequest, Parcelable
{
    ...
    public static final Parcelable.Creator<DisconnectRequest> CREATOR = new Parcelable.Creator<DisconnectRequest>()
    {
        public DisconnectRequest createFromParcel(Parcel in)
        {
            return new DisconnectRequest(in);
        }

        public DisconnectRequest[] newArray(int size)
        {
            return new DisconnectRequest[size];
        }
    };
     ...
     * @param in
     */
    public DisconnectRequest(Parcel in)
    {
     ...
     */
    public DisconnectRequest(int command)
    {
