 ...
 * ===========================================================================
 *
 * Class name: GetActiveBRD
 * Brief: BLE Command: get active basal rate delivery
 *
 * Create Date: 11/12/2015
 * $Revision: 24531 $
 * $Author: JacksonHuang $
 * $Id: GetActiveBRD.java 24531 2015-11-20 08:48:02Z JacksonHuang $
 */
...
public class GetActiveBRD implements IBLERequest
{
    ...
    // Instance
    private static volatile GetActiveBRD mInstance = null;
    ...
    // Indication Response
    private GetActiveBRDResponse mGetActiveBRDResponse = 
                                            new GetActiveBRDResponse();    
    ...
    private GetActiveBRD(Context context)
    {
        mContext = context;       
    }    
     ...
     * 
     */
    public static GetActiveBRD getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new GetActiveBRD(context);
        }
        else
        {
    ...
    {   
        ...
        {       
            ...
            request.setUUID16(new SafetyNumber<Integer>(
                    UUID.UUID16.IDD_STATUS_READER_CP,
                    -UUID.UUID16.IDD_STATUS_READER_CP));
    ...
    /**
     * Indication of GetActiveBRD
     * 
     */    
    
    class GetActiveBRDResponse implements ResponseProcess
    {
        ...
        public void doProcess(Context context, Intent intent)
        {
            Debug.printD(TAG, "Response enter ==> GetActiveBRD");
            ...
            switch(iOpCode)
            {
            case ControlPointConstant.OpCode.IDSREAD_ACTIVE_BASAL_RESP:
                ...
                if (iE2EResult == E2E_Result.RESULT_OK)
                {
                    ...
                    Debug.printD(TAG, " [GetActiveBRD]: E2E_Result.RESULT_OK");
                }
                else
                {
                    isResult = SafetyBoolean.FALSE;
                    Debug.printD(TAG, " [GetActiveBRD]: E2E_Result.RESULT_NNNNNNNNNNNNNNNNNNNNNOK");
                }
            ...
            case ControlPointConstant.OpCode.IDSREAD_RESP:
                ...
                if (iCommandCode == 
                        ControlPointConstant.OpCode.IDSREAD_ACTIVE_BASAL)
                {
