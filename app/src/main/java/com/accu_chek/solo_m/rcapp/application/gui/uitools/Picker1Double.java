 ...
 * ===========================================================================
 *
 * Class name: Picker1Double
 * Brief: Provide the interface function of the Picker1Double UI component
 *
 * Create Date: 12/09/2014
 * $Revision: 24175 $
 * $Author: AdamChen $
 * $Id: Picker1Double.java 24175 2015-11-16 09:33:09Z AdamChen $
 */
...
public class Picker1Double extends PickerDoubleBase
{

    final static int PICKER_LAYOUT_ID = Picker1.PICKER_LAYOUT_ID;
    
    final static int PICKER_UNIT_ID = Picker1.PICKER_UNIT_ID;
    
    final static int PICKER_TITLE_ID = Picker1.PICKER_TITLE_ID;
     ...
     * @param value
     */
    public Picker1Double(double value)
    {
     ...
     * @param unitValueId
     */
    public Picker1Double(double value, int unitValueId)
    {
