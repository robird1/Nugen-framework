 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ChangeConfigurationParameter
 * Brief: 
 *
 * Create Date: 2015/7/1
 * $Revision: 20933 $
 * $Author: kevenwu $
 * $Id: ChangeConfigurationParameter.java 20933 2015-10-05 08:34:57Z kevenwu $
 */
...
public class ChangeConfigurationParameter implements IRPCCommandHandler
{
    /**
    ...
    {        
        try
        {
            ByteBuffer value = ByteBuffer.wrap(invocation.getArguments().get(0)
                    .getValue().getByteArray());
            int parameterId = value.getShort();
            
            ConfigParameter.getParameterById(parameterId).getHandler()
                    .change(commandSet, invocation);
        }
