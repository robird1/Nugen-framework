 ...
 * Brief: BLE Activity: set TBR adjustment
 *
 * Create Date: 11/11/2015
 * $Revision: 25033 $
 * $Author: KiddYeh $
 * $Id: BLEACT_SetTbrAdj.java 25033 2015-11-27 10:38:45Z KiddYeh $
 */
...
public class BLEACT_SetTbrAdj extends AbstractBLEStateHandler
{
    ...
    private ResponseSetTbrAdj mResponseSetTbrAdj = 
                                            new ResponseSetTbrAdj();
    ...
    public BLEACT_SetTbrAdj(BLECallbackContext callbackContext,
    ...
    {    
        ...
        if (bTbrSetFlag == BIT0_SET)
        {
            ...
            mChangeTbr = SAFETY_TRUE;
        }
        else
        {
            iPkgLen = GET_ACTIVE_BRD_RESPONSE_BASIC_LEN;
            
            mChangeTbr = SAFETY_FALSE;
        }
        ...
        else
        {
            ...
            // create TBR Data Array
            createTbrDataArray();
            
            callSetTbrAdjustment();
        }
    }    
    ...
    protected void retryCommand()
    {
        ...
        case ControlPointConstant.OpCode.IDSCMD_SET_TBR_ADJ:
            ...
            Debug.printD(TAG, "[Retry CMD] Set TBR Adj E2E:" + mE2ERetryCount
                              + "TO:" + mProcedureRetryCount);
    ...
    /**
     * Call command: set TBR adjustment
     *          
     * @return None
     * 
     */    
    
    protected void callSetTbrAdjustment()
    {
        Debug.printD(TAG, "[Call CMD] Set Tbr Adjustment ");
        
        // Add Request: BLE_SEQ94 get basal rate template status
        mActCbContext.getBLERequestHandler().addRequest(
                            SetTbrAdjustment.getInstance(mActContext), 
                            mParameter, mResponseSetTbrAdj);
        
        mBLECommand = ControlPointConstant.OpCode.IDSCMD_SET_TBR_ADJ;
    ...
    /**
     * Response call back for SetTbrAdjustment 
     * 
     */    
    
    private class ResponseSetTbrAdj implements ResponseCallbackWithData
    {        
        /**
         * Action when command response is returned
         * 
        ...
        public void onRequestCompleted(SafetyBoolean result, ResponsePack pack)
        {
            ...
            else
            {
                ...
                handleSetTbrAdj(response.getData());
            }
        }
