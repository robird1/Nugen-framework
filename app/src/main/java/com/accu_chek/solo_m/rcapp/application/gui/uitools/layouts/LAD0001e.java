 ...
 *
 * Class name: LAD0001e
 * Brief: Provide the function of the LAD0001e layout
 *
 * Create Date: 01/22/2015
 * $Revision: 24175 $
 * $Author: AdamChen $
 * $Id: LAD0001e.java 24175 2015-11-16 09:33:09Z AdamChen $
 */
...
public class LAD0001e extends WarningLayoutBase
{

    private static final int LAYOUT_ID = R.layout.lad0001e;
     ...
     * @param activity
     */
    public LAD0001e(Activity activity)
    {
        super(activity);
    }
     ...
     */
    public void setValue(int total, String right_txt)
    {
        TextView textView = (TextView) mViewGroup
                .findViewById(R.id.warning_text_1st_line_left);
        textView.setText(total);
        textView = (TextView) mViewGroup.findViewById(R.id.warning_text_1st_line_right);
