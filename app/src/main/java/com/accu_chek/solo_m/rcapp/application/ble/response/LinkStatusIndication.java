 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.ble.response.LinkStatusIndication
 * Brief: 
 *
 * Create Date: 2015/7/2
 * $Revision: 20560 $
 * $Author: DWYang $
 * $Id: LinkStatusIndication.java 20560 2015-10-01 14:13:14Z DWYang $
 */
...
public class LinkStatusIndication implements IResponse, Parcelable
{
    /**
     * Command code
     */
    ...
    public static final Parcelable.Creator<LinkStatusIndication> CREATOR = new Parcelable.Creator<LinkStatusIndication>()
    {
        public LinkStatusIndication createFromParcel(Parcel in)
        {
            return new LinkStatusIndication(in);
        }

        public LinkStatusIndication[] newArray(int size)
        {
            return new LinkStatusIndication[size];
        }
    };

    public LinkStatusIndication()
    {
     ...
     * @param in
     */
    public LinkStatusIndication(Parcel in)
    {
     ...
     */
    public LinkStatusIndication(int command)
    {
     ...
     * @return LinkQuality
     */
    public SafetyNumber<Integer> getLinkQuality()
    {
        return new SafetyNumber<Integer>(this.mLinkQuality, (-this.mLinkQuality));
    }
    /**
     * @return Rssi
     */
    public SafetyNumber<Integer> getRssi()
    {
        return new SafetyNumber<Integer>(this.mRssi, (-this.mRssi));
    }
    /**
     * @return TxPower
     */
    public SafetyNumber<Integer> getTxPower()
    {
        return new SafetyNumber<Integer>(this.mTxPower, (-this.mTxPower));
    }
    /**
     * 
     * @param message
    ...
    public void parseMessage()
    {
        ...
        this.mLinkQuality = buffer.get(); // 1 byte
        this.mRssi = buffer.get(); // 1 byte
        this.mTxPower = buffer.get(); // 1 byte
    }
