 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.continua.rpc.FirmwareUpgrade
 * Brief: 
 *
 * Create Date: 2015/6/11
 * $Revision: 23531 $
 * $Author: kevenwu $
 * $Id: FirmwareUpgrade.java 23531 2015-11-06 09:01:33Z kevenwu $
 */
...
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.EnterUpgradeMode;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ExitUpgradeMode;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.FirmwareUpgradeStatus;
import com.accu_chek.solo_m.rcapp.application.exception.ArgumentErrorException;

public class FirmwareUpgrade implements IRPCCommandHandler
{
    enum SubCommand
    {
        FW_UPGRADE_STATUS(0x0001, new FirmwareUpgradeStatus()),
        ENTER_UPGRADE_MODE(0x0002, new EnterUpgradeMode()),
        EXIT_UPGRADE_MODE(0x0003, new ExitUpgradeMode());
