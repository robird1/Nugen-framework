 ...
 * ===========================================================================
 *
 * Class name: ActivateBrpTemplate
 * Brief: BLE Command: active Brp template
 *
 * Create Date: 11/11/2015
 * $Revision: 24156 $
 * $Author: JacksonHuang $
 * $Id: ActivateBrpTemplate.java 24156 2015-11-16 05:50:26Z JacksonHuang $
 */
...
public class ActivateBrpTemplate implements IBLERequest
{
    ...
    // Instance
    private static volatile ActivateBrpTemplate mInstance = null;
    ...
    // Indication Response
    private ActivateBrpTemplateResponse mActivateBrpTemplateResponse = 
                                            new ActivateBrpTemplateResponse();    
    ...
    private ActivateBrpTemplate(Context context)
    {
        mContext = context;       
    }    
    
    /**
     * Return the one and only instance of the class WriteBrpTemplate
     * 
     * @param context [in] Context
     * 
     *          Interface to global information about an application environment
     ...
     * 
     */
    public static ActivateBrpTemplate getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new ActivateBrpTemplate(context);
        }
        else
        {
    ...
    {
        // Data to BLE
        byte[] data = { (byte)0x2E, (byte)0x12, (byte)0x01, (byte)0xFF,
                        (byte)0xFF};
    ...
    /**
     * Indication of ActivateBrpTemplate
     * 
     */  
    
    class ActivateBrpTemplateResponse implements ResponseProcess
    {
        ...
        public void doProcess(Context context, Intent intent)
        {
            Debug.printD(TAG, "Response enter ==> Activate BRP Template");
            ...
            switch(iOpCode)
            {
            case ControlPointConstant.OpCode
                                        .IDSCMD_ACT_PROFILE_TMPL_RESP:
                ...
                if (iE2EResult == E2E_Result.RESULT_OK)
                {
                    ...
                    Debug.printD(TAG, " [ActivateBrpTemplate]: E2E_Result.RESULT_OK");
                }
                else
                {
                    isResult = SafetyBoolean.FALSE;
                    Debug.printD(TAG, " [ActivateBrpTemplate]: E2E_Result.RESULT_NNNNNNNNNNNNNNNNNNNNNOK");
                }
            ...
            case ControlPointConstant.OpCode.IDSCMD_RESP:
                ...
                if (iCommandCode == 
                        ControlPointConstant.OpCode.IDSCMD_ACT_PROFILE_TMPL)
                {
                    Debug.printD(TAG, " [ActivateBrpTemplate]: STD CMD Error");
                    setupReturnResult(SafetyBoolean.FALSE, null);
                }
