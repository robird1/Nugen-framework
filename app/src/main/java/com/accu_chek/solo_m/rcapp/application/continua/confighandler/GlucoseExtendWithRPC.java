 ...
 * $Revision: 24579 $
 * $Author: kevenwu $
 * $Id: GlucoseExtendWithRPC.java 24579 2015-11-23 03:00:24Z kevenwu $
 */
...
import com.accu_chek.solo_m.rcapp.application.continua.segmenthandler.AllExtendWithRPCHandler;
...
/**
 * This class is used to handle the command of Glucose Extend with RPC.
 */
public class GlucoseExtendWithRPC implements IContinuaConfigHandler
{
    /**
     * The Segment of glucose extend with RPC configuration.
     */
    enum Segment
    {
        /**
        ...
        /**
         * The instance of health events segment.
         */
        HEALTH_EVENT(GlucoseSegmentId.HEALTH_EVENTS, 
                new SingleSegmentHandler(HealthEvent.class)),
                
        /**
         * The instance of patient record segment.
         */
        PATIENT_RECORD(GlucoseSegmentId.PATIENT_RECORD, 
                new SingleSegmentHandler(PatientRecord.class)),
        
        /**
         * The instance of note record segment.
         */
        NOTE_RECORD(GlucoseSegmentId.NOTE_RECORD, 
                new SingleSegmentHandler(NoteRecord.class)),
                
        /**
         * The instance of control glucose segment.
         */
        CONTROL_GLUCOSE(GlucoseSegmentId.CONTROL_GLUCOSE, 
                new SingleSegmentHandler(ControlGlucoseRecord.class)),        
                
        /**
         * The instance of get all segment.
         */
        ALL(GlucoseSegmentId.ALL, new AllExtendWithRPCHandler());
    ...
    /**
     * Clear all segment data in Glucose extend with RPC configuration.
     *
     * @param commandSet : The instance of Continua command set.
     *        Range: Valid object of ContinuaCommandSet.
     *        Unit: ContinuaCommandSet.
