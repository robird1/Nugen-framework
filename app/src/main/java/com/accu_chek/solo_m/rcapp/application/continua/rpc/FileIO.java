 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.continua.rpc.FileIO
 * Brief: 
 *
 * Create Date: 2015/6/11
 * $Revision: 23531 $
 * $Author: kevenwu $
 * $Id: FileIO.java 23531 2015-11-06 09:01:33Z kevenwu $
 */
...
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.file.DeleteFile;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.file.ReadFile;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.file.ReadFileAbort;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.file.WriteFile;
import com.accu_chek.solo_m.rcapp.application.exception.ArgumentErrorException;

public class FileIO implements IRPCCommandHandler
{
    enum SubCommand
    {
        READ_FILE(0x0001, new ReadFile()),
        WRITE_FILE(0x0002, new WriteFile()),
        READ_FILE_ABORT(0x0003, new ReadFileAbort()),
        DELETE_FILE(0x0004, new DeleteFile());
