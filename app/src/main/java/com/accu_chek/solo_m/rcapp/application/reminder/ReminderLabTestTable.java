 ...
 * ===========================================================================
 *
 * Class name: ReminderLabTestTable
 * Brief: 
 *
...
public class ReminderLabTestTable extends AbstractReminderTable
{
    ...
    protected void getDataFromContentValue(ContentValues values)
    {
        ...
        mTime = DatabaseUtil.getStringValue(values, COLUMN_TIME, mTime);
        mDate = DatabaseUtil.getStringValue(values, COLUMN_DATE, mDate);
        mTone = DatabaseUtil.getStringValue(values, COLUMN_TONE, mTone);
    ...
    public Uri onUri()
    {
        return UrlType.reminderLabTestUri;
    }
    ...
    {
        ReminderLabTestTable model = null;
        ...
        model = new ReminderLabTestTable();
    ...
    {
        return ReminderLabTestTable.COLUMN_RECORD_ID;
    }
    
    @Override
    protected String getTableName()
    {
        return DBHelper.REMINDER_LAB_TEST_TABLE;
    }
