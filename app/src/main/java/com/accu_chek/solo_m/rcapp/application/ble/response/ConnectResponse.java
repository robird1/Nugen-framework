...
/**
 * The command code is CommsConstant.CommandCode.BT_CONNECT
 * 
 * @author EDLiu
 * @version 1.0
 * @created 24-Feb-2015 6:02:59 PM
 */
public class ConnectResponse implements IResponse, Parcelable
{
    ...
    public static final Parcelable.Creator<ConnectResponse> CREATOR = new Parcelable.Creator<ConnectResponse>()
    {
     ...
     * @param in
     */
    public ConnectResponse(Parcel in)
    {
     ...
     */
    public ConnectResponse(int command)
    {
