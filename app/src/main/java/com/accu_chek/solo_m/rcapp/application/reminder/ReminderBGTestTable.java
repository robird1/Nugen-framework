...
public class ReminderBGTestTable extends AbstractReminderTable
{
    ...
    {
        int ch1value = CommonUtils.encodeCH1Value(EMWRList.EMW48302.getCodeId());
        int ch2value = CommonUtils.encodeCH2Value(EMWRList.EMW48302.getCodeId());
    ...
    public Uri onUri()
    {
        return UrlType.reminderBGTestUri;
    }
    ...
    {
        ReminderBGTestTable model = null;
    ...
    {
        return ReminderBGTestTable.COLUMN_RECORD_ID;
    }
    
    @Override
    protected String getTableName()
    {
        return DBHelper.REMINDER_BG_TEST_TABLE;
    }
