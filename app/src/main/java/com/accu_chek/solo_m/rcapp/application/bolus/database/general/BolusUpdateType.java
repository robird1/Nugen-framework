 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.bolus.database.BolusUpdateType
 * Brief: 
 *
 * Create Date: 2015¦~7¤ë30¤é
 * $Revision: 20521 $
 * $Author: DWYang $
 * $Id: BolusUpdateType.java 20521 2015-10-01 11:09:05Z DWYang $
 */
...
public class BolusUpdateType implements IUpdateSelectType
{
    ...
    /**
     * 
     * Set select type for update fucntion
     *
    ...
    /**
     * 
     * Set select argument for update function.
     *
