 ...
 */
public class ResetConnectionRequest implements IRequest, Parcelable
{
    ...
    public static final Parcelable.Creator<ResetConnectionRequest> CREATOR = new Parcelable.Creator<ResetConnectionRequest>()
    {
        public ResetConnectionRequest createFromParcel(Parcel in)
        {
            return new ResetConnectionRequest(in);
        }

        public ResetConnectionRequest[] newArray(int size)
        {
            return new ResetConnectionRequest[size];
        }
    };
     ...
     * @param in
     */
    public ResetConnectionRequest(Parcel in)
    {
     ...
     */
    public ResetConnectionRequest(int command)
    {
