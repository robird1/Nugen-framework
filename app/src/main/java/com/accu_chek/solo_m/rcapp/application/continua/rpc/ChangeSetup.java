 ...
 * $Revision: 21447 $
 * $Author: kevenwu $
 * $Id: ChangeSetup.java 21447 2015-10-14 02:27:25Z kevenwu $
 */
...
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ChangeCarbUnits;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ChangeLanguage;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ChangeMaxBolusThreshold;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ResetToFactoryDefaults;
import com.accu_chek.solo_m.rcapp.application.exception.ArgumentErrorException;

/**
 * This class is used to handle the RPC command of change setup.
 */
public class ChangeSetup implements IRPCCommandHandler
{
    /**
     * The enumeration represents the sub command of change setup.
     */
    enum SubCommand
    {
        /**
         * The instance of change language command.
         */
        CHANGE_LANGUAGE(0x0037, new ChangeLanguage()),
        
        /**
         * The instance of reset to factory defaults command.
         */
        RESET_TO_FACTORY_DEFAULTS(0x0084, new ResetToFactoryDefaults()),
        
        /**
         * The instance of change the max Bolus threshold.
         */
        CHANGE_MAX_BOLUS_THRESHOLD(0x0049, new ChangeMaxBolusThreshold()),
        
        /**
         * The instance of change carbohydrate unit.
         */
        CHANGE_CARB_UNITS(0x0054, new ChangeCarbUnits());
