 ...
 * ===========================================================================
 *
 * Class name: WriteBrpTemplate
 * Brief: BLE Command: write BRP template
 *
 * Create Date: 11/04/2015
 * $Revision: 24156 $
 * $Author: JacksonHuang $
 * $Id: WriteBrpTemplate.java 24156 2015-11-16 05:50:26Z JacksonHuang $
 */
...
public class WriteBrpTemplate implements IBLERequest
{
    ...
    // Instance
    private static volatile WriteBrpTemplate mInstance = null;
    ...
    // Indication Response
    private WriteBrpTemplateResponse mWriteBrpTemplateResponse = 
                                            new WriteBrpTemplateResponse();
    ...
    private WriteBrpTemplate(Context context)
    {
        mContext = context;       
    }    
     ...
     * 
     */
    public static WriteBrpTemplate getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new WriteBrpTemplate(context);
        }
        else
        {
    ...
    /**
     * Indication of WriteBrpTemplate
     * 
     */  
    
    class WriteBrpTemplateResponse implements ResponseProcess
    {
        ...
        public void doProcess(Context context, Intent intent)
        {
            Debug.printD(TAG, "Response enter ==> Write BRP Template");
            ...
            case ControlPointConstant.OpCode
                                        .IDSCMD_WRITE_BASAL_RATE_PROFILE_RESP:
                ...
                if (iE2EResult == E2E_Result.RESULT_OK)
                {
                    ...
                    Debug.printD(TAG, " [WriteBrpTemplate]: E2E_Result.RESULT_OK");
                }
                else
                {
                    isResult = SafetyBoolean.FALSE;
                    Debug.printD(TAG, " [WriteBrpTemplate]: E2E_Result.RESULT_NNNNNNNNNNNNNNNNNNNNNOK");
                }
            ...
            case ControlPointConstant.OpCode.IDSCMD_RESP:
                ...
                if (iCommandCode == 
                        ControlPointConstant.OpCode
                                            .IDSCMD_WRITE_BASAL_RATE_PROFILE)
                {
                    Debug.printD(TAG, " [WriteBrpTemplate]: STD CMD Error");
                    setupReturnResult(SafetyBoolean.FALSE, null);
                }
