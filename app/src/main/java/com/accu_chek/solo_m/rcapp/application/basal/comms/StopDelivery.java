 ...
 * ===========================================================================
 *
 * Class name: StopDelivery
 * Brief: BLE Command: Stop Delivery
 *
 * Create Date: 11/12/2015
 * $Revision: 24156 $
 * $Author: JacksonHuang $
 * $Id: StopDelivery.java 24156 2015-11-16 05:50:26Z JacksonHuang $
 */
...
public class StopDelivery implements IBLERequest
{
    ...
    // Instance
    private static volatile StopDelivery mInstance = null;
    ...
    // Indication Response
    private StopDeliveryResponse mStopDeliveryResponse = 
                                            new StopDeliveryResponse();
    ...
    private StopDelivery(Context context)
    {
        mContext = context;       
    }    
     ...
     * 
     */
    public static StopDelivery getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new StopDelivery(context);
        }
        else
        {
    ...
    {
        // Data to BLE
        byte[] data = { (byte)0x5A, (byte)0x0F, (byte)0x33 };
    ...
    /**
     * Indication of CancelTbrAdj
     * 
     */    
    
    class StopDeliveryResponse implements ResponseProcess
    {
            ...
            case ControlPointConstant.OpCode.IDSCMD_RESP:
                ...
                if (iCommandCode == 
                        ControlPointConstant.OpCode
                                            .IDSCMD_SET_THERAPY_CONTROL_STATE)
                {
                    // Get E2E Result
                    ...
                    if (iE2EResult == E2E_Result.RESULT_OK)
                    {
                        ...
                        Debug.printD(TAG, " [StopDelivery]: E2E_Result.RESULT_OK");
                    }
                    else
                    {
                        isResult = SafetyBoolean.FALSE;
                        Debug.printD(TAG, " [StopDelivery]: E2E_Result.RESULT_NNNNNNNNNNNNNNNNNNNNNOK");
                    }
