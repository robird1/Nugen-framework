 ...
 * ===========================================================================
 *
 * Class name: CancelTbrAdj
 * Brief: BLE Command: cnacel TBR adjustment
 *
 * Create Date: 11/12/2015
 * $Revision: 24156 $
 * $Author: JacksonHuang $
 * $Id: CancelTbrAdj.java 24156 2015-11-16 05:50:26Z JacksonHuang $
 */
...
public class CancelTbrAdj implements IBLERequest
{
    ...
    // Instance
    private static volatile CancelTbrAdj mInstance = null;
    ...
    // Indication Response
    private CancelTbrAdjResponse mCancelTbrAdjResponse = 
                                            new CancelTbrAdjResponse();    
    ...
    private CancelTbrAdj(Context context)
    {
        mContext = context;       
    }    
     ...
     * 
     */
    public static CancelTbrAdj getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new CancelTbrAdj(context);
        }
        else
        {
    ...
    class CancelTbrAdjResponse implements ResponseProcess
    {
        ...
        public void doProcess(Context context, Intent intent)
        {
            ...
            case ControlPointConstant.OpCode.IDSCMD_RESP:
                ...
                if (iCommandCode == 
                        ControlPointConstant.OpCode.IDSCMD_CANCEL_TBR)
                {
                    // Get E2E Result
                    ...
                    if (iE2EResult == E2E_Result.RESULT_OK)
                    {
                        ...
                        Debug.printD(TAG, " [CancelTbrAdj]: E2E_Result.RESULT_OK");
                    }
                    else
                    {
                        isResult = SafetyBoolean.FALSE;
                        Debug.printD(TAG, " [CancelTbrAdj]: E2E_Result.RESULT_NNNNNNNNNNNNNNNNNNNNNOK");
                    }
