 ...
 *
 * Class name: LAD0020
 * Brief: Provide the function of the LAD0020 layout
 *
 * Create Date: 01/22/2015
 * $Revision: 24175 $
 * $Author: AdamChen $
 * $Id: LAD0020.java 24175 2015-11-16 09:33:09Z AdamChen $
 */
 ...
 */
public class LAD0020 extends LayoutBase
{

    private static final int LAYOUT_ID = R.layout.lad0020;
    
    private static final int BUTTON_CONTAINER = R.id.lad0020_tableLayout;
     ...
     * 
     */
    public LAD0020(Activity activity)
    {
        super(activity);
    }
    ...
    public void addButtonDivider()
    {
        ...
        View tr = getLayoutInflater().inflate(R.layout.divider,
    ...
    /**
     * 
     * Add 20px to 6px = 26px between dates
     *
     * @return void [out] Delete pre line return if exist. Parameter Description
     */
    public void addSpacing20px()
    {
        // TODO check divider (layout, margin, width)
        ViewGroup buttonContainer = findContainerById(getButtonContainer());
        View tr = getLayoutInflater().inflate(R.layout.button_spacing20px,
                buttonContainer, false);
        buttonContainer.addView(tr);
    }
     ...
     * @return void [out] Delete pre line return if exist. Parameter Description
     */
    public void addSpacing19px()
    {
        // TODO check divider (layout, margin, width)
        ViewGroup buttonContainer = findContainerById(getButtonContainer());
        View tr = getLayoutInflater().inflate(R.layout.button_spacing19px,
                buttonContainer, false);
        buttonContainer.addView(tr);
    }
    ...
    public void addButtons(ButtonBasic... buttons)
    {
        ...
        for (ButtonBasic button : buttons)
        {
            ...
            if (buttonCount != 0)
            {
                View space = inflater.inflate(R.layout.button_spacing6px,
                        buttonContainer, false);
    ...
    public void addInstruction(int instructionTextId)
    {
        ...
        margin.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 0));
