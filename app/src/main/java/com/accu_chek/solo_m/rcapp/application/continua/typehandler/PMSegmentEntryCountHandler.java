 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.ContinuaCommandController.handler.TotalPMSegmentEntry
 * Brief: 
 *
 * Create Date: 2015/3/19
 * $Revision: 20933 $
 * $Author: kevenwu $
 * $Id: PMSegmentEntryCountHandler.java 20933 2015-10-05 08:34:57Z kevenwu $
 */
...
/**
 * This class is used to handle the command for getting the count of segment entry.
 */
public class PMSegmentEntryCountHandler implements IContinuaCommandHandler
{
    /**
     * Query the database for the segment count depend on configuration and segment
