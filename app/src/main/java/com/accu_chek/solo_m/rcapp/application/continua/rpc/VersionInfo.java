 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.continua.rpc.VersionInfo
 * Brief: 
 *
 * Create Date: 2015/6/11
 * $Revision: 23531 $
 * $Author: kevenwu $
 * $Id: VersionInfo.java 23531 2015-11-06 09:01:33Z kevenwu $
 */
...
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ReadCurrentVersions;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ReadExternalDeviceInfo;
import com.accu_chek.solo_m.rcapp.application.continua.rpc.subcmd.ReadInternalCompInfo;
import com.accu_chek.solo_m.rcapp.application.exception.ArgumentErrorException;

public class VersionInfo implements IRPCCommandHandler
{
    enum SubCommand
    {
        READ_CURRENT_VERSIONS(0x0001, new ReadCurrentVersions()),
        READ_INTERNAL_COMP_INFO(0x0002, new ReadInternalCompInfo()),
        READ_EXTERNAL_DEVICE_INFO(0x0003, new ReadExternalDeviceInfo());
