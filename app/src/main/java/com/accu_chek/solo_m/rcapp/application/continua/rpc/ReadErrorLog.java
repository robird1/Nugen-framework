 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.continua.rpc.ReadErrorLog
 * Brief: 
 *
 * Create Date: 2015/6/24
 * $Revision: 20933 $
 * $Author: kevenwu $
 * $Id: ReadErrorLog.java 20933 2015-10-05 08:34:57Z kevenwu $
 */
...
public class ReadErrorLog implements IRPCCommandHandler
{    
    /**
     * Read the error log from error log file and return to Agent sequentially.
     *
    ...
    public void handle(ContinuaCommandSet commandSet, RPCCommandInvocation invocation)
    {
        ...
        // Temporary result, wait for log file module.
        byte[] result = {};
