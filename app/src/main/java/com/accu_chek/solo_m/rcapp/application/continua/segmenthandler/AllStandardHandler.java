 ...
 * $Revision: 20933 $
 * $Author: kevenwu $
 * $Id: AllStandardHandler.java 20933 2015-10-05 08:34:57Z kevenwu $
 */
...
/**
 * This class is used to handle the command to get all segment of standard
 * configuration. 
 */
public class AllStandardHandler implements IContinuaSegmentHandler
{
    /**
    ...
    /**
     * Get the count of all necessary data of standard configuration and transfers the data 
     * to Continua Agent via ContinuaCommandController.
     *
     * @param commandSet : The instance of Continua command set.
     *        Range: Valid object of ContinuaCommandSet.
     *        Unit: ContinuaCommandSet.
