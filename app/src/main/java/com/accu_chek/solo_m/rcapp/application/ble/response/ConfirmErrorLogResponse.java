 ...
 * $Revision: 23058 $
 * $Author: KiddYeh $
 * $Id: ConfirmErrorLogResponse.java 23058 2015-11-03 01:19:18Z KiddYeh $
 */
...
public class ConfirmErrorLogResponse implements IResponse, Parcelable
{
    /**
     * Command Code
     */
    ...
    public static final Parcelable.Creator<ConfirmErrorLogResponse> CREATOR = new Parcelable.Creator<ConfirmErrorLogResponse>()
    {
        public ConfirmErrorLogResponse createFromParcel(Parcel in)
        {
            return new ConfirmErrorLogResponse(in);
        }

        public ConfirmErrorLogResponse[] newArray(int size)
        {
            return new ConfirmErrorLogResponse[size];
        }
    };

    public ConfirmErrorLogResponse()
    {
     ...
     * @param in
     */
    public ConfirmErrorLogResponse(Parcel in)
    {
     ...
     */
    public ConfirmErrorLogResponse(int command)
    {
