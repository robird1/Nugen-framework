 ...
 * ===========================================================================
 *
 * Class name: IntentIntegrator
 * Brief: Helps ease integration with Barcode Scanner via intent
 *
 * Create Date: 07/08/2015
 * $Revision: 24935 $
 * $Author: AdamChen $
 * $Id: IntentIntegrator.java 24935 2015-11-26 09:44:44Z AdamChen $
 */
...
public class IntentIntegrator
{
    ...
    private String buttonYes = null;
    
    private String buttonNo = null;
    
    private List<String> targetApplications = null;
    
    private Map<String, Object> moreExtras = null;
            ...
            int resultCode, Intent intent)
    {
        ...
        if (requestCode == REQUEST_CODE)
        {
            if (resultCode == Activity.RESULT_OK)
            {
                ...
                ret =  new IntentResult(contents, formatName, rawBytes,
                        orientation, errorCorrectionLevel);
            }
            else
            {
            ret =  new IntentResult();
        }
        }
        return ret;
    }
    ...
    private String findTargetAppPackage(Intent intent)
    {
        ...
        if (availableApps != null)
        {
            ...
            {
                contains = contains(availableApps, targetApp);
                if (contains)
                {
                    ret =  targetApp;
                }
