 ...
 * ===========================================================================
 *
 * Class name: com.accu_chek.solo_m.rcapp.application.comms.ble.ReadAnnunciationStatus
 * Brief: This class handles ReadAnnunciationStatus request and its response.
 *
 * Create Date: 2015/11/17
 * $Revision: 22446 $
 * $Author: KiddYeh $
 * $Id: ReadAnnunciationStatus.java 22446 2015-10-23 09:03:35Z KiddYeh $
 */
...
public class ReadAnnunciationStatus implements IBLERequest
{
    private static final String TAG = "ReadAnnunciationStatus";
    
    /**
     * The instance of ReadAnnunciationStatus class
     */
    private static volatile ReadAnnunciationStatus mInstance = null;
     ...
     * 
     * 
     * Get the one and only instance of the class ReadAnnunciationStatus.
     * 
     ...
     *            Scaling: 1
     * 
     * @return mInstance : the one and only instance of the class ReadAnnunciationStatus
     *         Range: A valid object of ReadAnnunciationStatus
     *         Unit: ReadAnnunciationStatus
     *         Scaling: 1
     * 
     * @see mInstance: use this global variable to store the instance of the
     *      class ReadAnnunciationStatus
     */
    public static ReadAnnunciationStatus getInstance(Context context)
    {
        if (null == mInstance)
        {
            mInstance = new ReadAnnunciationStatus(context);
        }
        else
        {
     ...
     *            
     */
    private ReadAnnunciationStatus(Context context)
    {
        mContext = context;
    }
    ...
    {
        Debug.printD(TAG, "[doProcess]: ReadAnnunciationStatus ");
     ...
     * @see mCallback  
     */
    private void returnResult(SafetyBoolean isResult, ResponsePack pack)
    {
     ...
     *
     * 
     * This method handles the ReadAnnunciationStatus request. It sets the parameter of request 
     * and sends it out. 
     * 
    ...
    {
        Debug.printD(TAG, "[ReadAnnunciationStatus]: Request enter ");
        ...
        if ( null != request )
        {
            ...
            request.setUUID16(new SafetyNumber<Integer>(UUID16.IDD_ANNUNCIATION_STATUS,-UUID16.IDD_ANNUNCIATION_STATUS));
